...
[![Repo Size](https://img.shields.io/github/repo-size/berkeoruc/berkeos?style=for-the-badge&logo=github&logoColor=white&labelColor=1a1a2e&color=8957E5)](https://github.com/berkeoruc/berkeos)
...
<img src="assets/screenshots/berkefs.png" alt="BerkeFS" width="100%"/>
<br/><sub><b>📁 BerkeFS</b> — File operations</sub>
</td>
<td align="center" width="33%">
<img src="assets/screenshots/calc.png" alt="Calculator" width="100%"/>
<br/><sub><b>🧮 Calculator</b> — Built-in calc</sub>
</td>
<td align="center" width="33%">
<img src="assets/screenshots/sysinfo.png" alt="Sysinfo" width="100%"/>
...
|:---|:---|:---:|:---|
| 🟢 **Boot Chain** | `boot.asm`, `linker.ld` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | 32→64 bit Long Mode, page tables, kernel jump |
| 🟢 **VGA Text Mode** | `vga.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | 80×25 color text output, scrolling |
| 🟢 **Framebuffer** | `framebuffer.rs`, `font.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Graphical framebuffer, font rendering |
| 🟢 **IDT + PIC + PIT** | `idt.rs`, `pic.rs`, `pit.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Interrupts, 8259 PIC, 100Hz timer |
| 🟢 **PS/2 Keyboard** | `keyboard.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Scan code → keypress, layout support |
| 🟢 **Memory Paging** | `paging.rs`, `allocator.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | 2 MiB huge pages, heap allocator |
| 🟢 **ATA PIO Disk** | `ata.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Read/write sectors, disk detection |
| 🟢 **BerkeFS** | `berkefs.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Custom filesystem, dirs, files, mount |
| 🟢 **Shell (berkesh)** | `shell.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | 30+ commands, history, tab support |
| 🟢 **Deno Editor** | `deno.rs`, `editor.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Built-in text editor |
| 🟢 **RTC Clock** | `rtc.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Real-time clock, date/time |
| 🟢 **PC Speaker** | `pcspeaker.rs`, `audio.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Beep, melodies via PIT |
| 🟢 **Scheduler** | `scheduler.rs`, `process.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | Basic process scheduling |
| 🟢 **Syscalls** | `syscall.rs` | ![Implemented](https://img.shields.io/badge/✅-Implemented-2EA44F?style=flat-square) | System call interface |
| 🟡 **AHCI/SATA** | `ahci.rs` | ![Experimental](https://img.shields.io/badge/🧪-Experimental-FBCA04?style=flat-square) | SATA controller detection, WIP |
| 🟡 **USB Stack** | `usb/` | ![Experimental](https://img.shields.io/badge/🧪-Experimental-FBCA04?style=flat-square) | OHCI, USB storage — early stage |
| 🟡 **Network** | `net/`, `rtl8139.rs` | ![Experimental](https://img.shields.io/badge/🧪-Experimental-FBCA04?style=flat-square) | IPv4/ARP buffers, RTL8139 — early stage |
| 🟡 **Image Viewer** | `image.rs` | ![Experimental](https://img.shields.io/badge/🧪-Experimental-FBCA04?style=flat-square) | Basic image display |
| 🔴 **TCP/IP Stack** | — | ![Planned](https://img.shields.io/badge/📋-Planned-E4405F?style=flat-square) | Full networking support |
| 🔴 **Sound Card** | — | ![Planned](https://img.shields.io/badge/📋-Planned-E4405F?style=flat-square) | AC97/HDA audio driver |
| 🔴 **Multi-core SMP** | — | ![Planned](https://img.shields.io/badge/📋-Planned-E4405F?style=flat-square) | Multi-core CPU support |
| 🔴 **USB 3.0** | — | ![Planned](https://img.shields.io/badge/📋-Planned-E4405F?style=flat-square) | xHCI driver |
| 🔴 **GUI Desktop** | — | ![Planned](https://img.shields.io/badge/📋-Planned-E4405F?style=flat-square) | Windowed desktop environment |
| 🔴 **Package Manager** | — | ![Planned](https://img.shields.io/badge/📋-Planned-E4405F?style=flat-square) | Package installation & management |
...
<br/>
<img src="https://img.shields.io/badge/🧠-Kernel-E8792B?style=for-the-badge" alt="kernel"/>
<br/><br/>
<b>Custom Kernel</b>
<br/>
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/📁-BerkeFS-0071C5?style=for-the-badge" alt="filesystem"/>
<br/><br/>
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/🐚-berkesh-2EA44F?style=for-the-badge" alt="shell"/>
<br/><br/>
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/🖥️-Drivers-8957E5?style=for-the-badge" alt="drivers"/>
<br/><br/>
<b>Device Drivers</b>
<br/>
VGA · PS/2 · ATA · RTC<br/>
...
<tr>
<td align="center">
<img src="https://img.shields.io/badge/Total_Lines-~14,288-E8792B?style=for-the-badge&logo=codeclimate&logoColor=white" alt="total"/>
</td>
<td align="center">
<img src="https://img.shields.io/badge/Developer-43%25_(~6,143)-2EA44F?style=for-the-badge&logo=github&logoColor=white" alt="developer"/>
</td>
<td align="center">
<img src="https://img.shields.io/badge/AI_Assisted-57%25_(~8,145)-0071C5?style=for-the-badge&logo=openai&logoColor=white" alt="ai"/>
</td>
<td align="center">
<img src="https://img.shields.io/badge/Cost-0_TL-D22128?style=for-the-badge&logo=money&logoColor=white" alt="cost"/>
</td>
</tr>
</table>
...
sequenceDiagram
    ...
    participant KERN as 🦀 kernel_main
    participant DRV as 🔧 Drivers
    participant FS as 📁 BerkeFS
    participant SH as 🐚 berkesh

    FW->>BOOT: UEFI/BIOS handoff
    Note over BOOT: 32-bit Protected Mode
    BOOT->>BOOT: Setup page tables
    BOOT->>BOOT: Enable Long Mode (64-bit)
    BOOT->>KERN: Jump to kernel_main()
    
    Note over KERN: Rust no_std entry
    KERN->>DRV: Init VGA / Framebuffer
    KERN->>DRV: Init PS/2 Keyboard
    KERN->>DRV: Setup IDT + PIC + PIT
    KERN->>DRV: Init Scheduler
    KERN->>DRV: Detect ATA / AHCI
    KERN->>FS: Mount / Format BerkeFS
    KERN->>SH: Start Interactive Shell
    
    loop User Interaction
        SH->>SH: Read command
        SH->>FS: File operations
        SH->>DRV: Device access
        SH->>SH: Display output
    end
```
...
```mermaid
timeline
    title BerkeOS Development Roadmap
    
    section v0.7 — Stability & Polish
        Version Consistency   : Unify version across Cargo.toml, boot splash, shell, ver command
        README ↔ Code Sync    : Shell command table auto-generated from source
        Build Cleanup         : Resolve x86_64-berkeos.json vs x86_64-unknown-none
        Panic Handler         : Serial log, error codes, debug info
        CI Pipeline           : GitHub Actions — auto-build ISO on push
    
    section v0.8 — Core Improvements
        BerkeFS v2            : Reliability, journaling, larger file support
        Shell UX              : Tab completion, aliases, scripting basics
        Global State Refactor : Replace FS0..FS11 with drive registry
        First GitHub Release  : Downloadable ISO, changelog
    
    section v0.9 — Networking & Drivers
        TCP/IP Stack          : Full networking support
        Sound Card            : AC97 or HDA driver
        AHCI Completion       : Full SATA support
        USB Stabilization     : OHCI → working USB storage
    
    section v1.0 — Major Release
        Multi-core SMP        : AP startup, shared scheduler
        GUI Desktop           : Windowed environment
        Package Manager       : Install/remove packages
        Installer             : Disk installation support
```
...
[![Feature Request](https://img.shields.io/badge/Request_Feature-0071C5?style=for-the-badge&logo=github&logoColor=white)](https://github.com/berkeoruc/berkeos/issues)
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/Rust-Community-000000?style=for-the-badge&logo=rust&logoColor=white" alt="rust"/>
<br/><br/>
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/OSDev-Wiki-0071C5?style=for-the-badge&logo=wikipedia&logoColor=white" alt="osdev"/>
<br/><br/>
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/Free_AI-Tools-8957E5?style=for-the-badge&logo=openai&logoColor=white" alt="ai"/>
<br/><br/>
...
<td align="center" width="25%">
<br/>
<img src="https://img.shields.io/badge/Open_Source-❤️-D22128?style=for-the-badge&logo=opensourceinitiative&logoColor=white" alt="opensource"/>
<br/><br/>
...
[![Star History Chart](https://api.star-history.com/svg?repos=berkeoruc/berkeos&type=Date)](https://star-history.com/#berkeoruc/berkeos&Date)

<br/>

[![Made with Love](https://img.shields.io/badge/Made_with-❤️-D22128?style=for-the-badge)](https://github.com/berkeoruc)
[![From Turkey](https://img.shields.io/badge/From-Turkey_🇹🇷-E30A17?style=for-the-badge)](https://github.com/berkeoruc)
[![Built with Rust](https://img.shields.io/badge/Built_with-Rust_🦀-000000?style=for-the-badge&logo=rust&logoColor=white)](https://www.rust-lang.org/)
